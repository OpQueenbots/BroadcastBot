...
async def startprivate(client, message):
    ...
    joinButton = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("𝗖𝗵𝗮𝗻𝗻𝗲𝗹", url="https://t.me/Kalakar_Sangram"),
                InlineKeyboardButton(
                    "𝗚𝗿𝗼𝘂𝗽", url="https://t.me/Red_Wine_Op"
                ),
            ]
        ]
    )
    welcomed = f"Hey <b>{message.from_user.first_name}</b>\nI'm a simple Telegram bot that can broadcast messages and media to the bot subscribers. Made by @Kalakar_Sangram and @Red_Wine_Op.\n\n
